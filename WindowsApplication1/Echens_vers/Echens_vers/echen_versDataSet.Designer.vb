...
Partial Public Class echen_versDataSet
    ...
    Partial Public Class EchDataTableDataTable
        ...
        Public Overloads Function AddEchDataTableRow( _
                    ...
                    ByVal Prix_immob As Double) As EchDataTableRow
            Dim rowEchDataTableRow As EchDataTableRow = CType(Me.NewRow,EchDataTableRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nom_bene, pre_bene, Nothing, Adr_residence, Nom_Quartier, Nom_commune, Nom_wilaya, Nothing, Mont_loy_ret, Mont_vers_init, Mont_Gar, Coef_Appli, Nothing, Duree_vers, Coef_ech, Taux_Abat, Nom_daira, Nothing, Adr_Loc, Prix_immob, Nothing}
    ...
    Partial Public Class EchDataTableTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Abattement.Cd_abat, Abattement.Duree_vers, Abattement.Coef_ech, Aba"& _ 
                ...
                ", Residence.Cd_residence, Commune.Nom_commune"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Quartier INNER JO"& _ 
                "IN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Daira INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Commune "& _ 
                "ON Daira.Cd_daira = Commune.Cd_daira ON Quartier.Cd_commune = Commune.Cd_commune"& _ 
                " INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Residence ON Quartier.Cd_Quartier = Reside"& _ 
                "nce.Cd_Quartier INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Beneficiaire INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                       Abattement INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Echencer_"& _ 
                "Versement ON Abattement.Cd_abat = Echencer_Versement.abattement_cd_abat ON "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   "& _ 
                "                      Beneficiaire.Cd_bene = Echencer_Versement.beneficiaire_cd_"& _ 
                "bene INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Local ON Beneficiaire.Cd_bene = Local."& _ 
                "beneficiaire_cd_bene ON Residence.Cd_residence = Beneficiaire.residence_cd_resid"& _ 
                "ence INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Wilaya ON Daira.Cd_wilaya = Wilaya.Cd_"& _ 
                "wilaya"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = New Global.System.Data.SqlClient.SqlConnection(Global.WindowsApplication1.My.MySettings.Default.droit_propriter_etatConnectionString)
            Me._commandCollection(1).CommandText = "SELECT        b.Cd_bene, b.nom_bene, b.pre_bene, b.Date_nais, b.lieu_nais, b.pre_"& _ 
                ...
                ", q.Nom_Quartier, c.Cd_commune, c.Nom_commune, d.Cd_daira , d.Nom_daira, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                    w.Cd_wilaya , w.Nom_wilaya, e.Num_tab_vers, e.Dat_tab_vers, "& _ 
                "e.Mont_loy_ret, e.Mont_vers_init, e.Mont_Gar, e.Coef_Appli, a.Cd_abat, a.Duree_v"& _ 
                "ers, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         a.Coef_ech, a.Taux_Abat, l.Cd_Loc, l.Type_Loc, l"& _ 
                ".Adr_Loc, l.Date_Utili_Loc, l.Zone_Loc, l.N_Loc, l.Disc_immb, l.N_bat, l.N_escal"& _ 
                ", l.N_etage, l.N_port, l.Prix_immob, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         l.Cd_rapp_eval_i"& _ 
                "mmb"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Beneficiaire AS b INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Resi"& _ 
                "dence AS r ON b.residence_cd_residence = r.Cd_residence INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "             Quartier AS q ON r.Cd_Quartier = q.Cd_Quartier INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"        "& _ 
                "                 Commune AS c ON q.Cd_commune = c.Cd_commune INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  Daira AS d ON c.Cd_daira = d.Cd_daira INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "             Wilaya AS w ON d.Cd_wilaya = w.Cd_wilaya INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"              "& _ 
                "           Echencer_Versement AS e ON b.Cd_bene = e.beneficiaire_cd_bene INNER J"& _ 
                "OIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Abattement AS a ON e.abattement_cd_abat = a.Cd_aba"& _ 
                "t INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Local AS l ON b.Cd_bene = l.beneficiaire_"& _ 
                "cd_bene"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (b.Cd_bene = @Cd_bene)"
