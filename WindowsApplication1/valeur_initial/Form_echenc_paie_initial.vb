...
Public Class Form_echenc_paie_initial
    ...
    Private Sub Form_echenc_paie_initial_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Valeur_inDataSet.NomCDataTable' table. You can move, or remove it, as needed.
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        form_RPCR.cd_ben = Me.Beneficiaire_cd_beneComboBox.SelectedValue
